...
ProcessPointClouds<PointT>::ProcessPointClouds() {
    minPointRoof << -1.5, -1.7, -1, 1;
    maxPointRoof << 2.6, 1.7, -.4, 1;
}
...
typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
{
    ...
    typename pcl::PointCloud<PointT>::Ptr cloudRemoveRoof (new pcl::PointCloud<PointT>);
    pcl::CropBox<PointT> roof;
    roof.setMin(minPointRoof);
    roof.setMax(maxPointRoof);
    roof.setInputCloud(cloudRegion);
    roof.setNegative(true);
    roof.filter(*cloudRemoveRoof);
